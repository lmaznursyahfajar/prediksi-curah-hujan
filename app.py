...
from utils.data_loader import load_data, load_geojson, compute_stats
...
if st.session_state.get("last_api_hour") != now_hour:
    ...
    if updated is not None:
        from utils.data_loader import reload_data
        df = reload_data()
...
elif page == "🤖  Prediksi Curah Hujan Ekstrem":
    from pages import prediction
    prediction.render(df)

elif page == "🌾  Analisis Pertanian":
    from pages import agriculture
    agriculture.render(df, gdf)

elif page == "🚨  Analisis Bencana":
